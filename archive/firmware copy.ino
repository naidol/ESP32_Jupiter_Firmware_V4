...
#include <std_msgs/msg/empty.h>      // <-- ADD THIS INCLUDE
...
// Tell the main file that these exist in imu_bno055.cpp
...
// --- ADD THE NEW SUBSCRIBER VARIABLES ---
...
void saveImuCallback(const void * msgin) {
    // DO NOT touch Preferences or the BNO055 here. 
    // Just flip the safety flag.
...
void loop() {
    ...
    // delay(100);
    // Execute the flash save when the CPU is free
    if (trigger_imu_save) {
        perform_imu_save();
    }
}
